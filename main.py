...
Node1 = Node(max_capacity=5, is_end=False, name="Node1")
Node2 = Node(max_capacity=5, is_end=False, name="Node2")
Node3 = Node(max_capacity=5, is_end=True, name="Node3")
...
print(propagate(agents, tracks, dt=1))
